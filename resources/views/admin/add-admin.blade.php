            ...
            <div class="col-md-6 offset-md-3 shadow-lg" id="register-form">
                ...
                <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data" id="form"
                    ...
                    <div class="email-pass-box">
                        ...
                        <div class="d-flex align-items-center justify-content-between g-1">
                            ...
                            <div class="w-100">
                                <label for="" class="form-label">Enter Role</label>
                                <input type="text" name="role" placeholder="Role"
                                    class="form-control mt-2 @error('role') is-invalid @enderror">
                                @error('role')
                                    <span>{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="create-btn text-center mt-2">
                        ...
                        <a href="{{ route('YourDashboardPage') }}" class="btn btn-dark py-2 px-3  fw-bold">Back</a>
                    </div>
                </form>
            </div>
        </div>
