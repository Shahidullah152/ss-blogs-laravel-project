    ...
    <div class="container">
        <div class="row position-relative">
            <div class="col-md-12 d-flex justify-content-between align-items-center my-1 w-100">
                <h1 class="mb-2 text-secondary" id="PostCategoryDraftPublishTitle">Draft Posts</h1>
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped text-center">
                        ...
                        {{-- @foreach ($draftPosts as $user) --}}
                        @foreach ($draftPosts as $posts)
                            <tr>
                                <td>{{ $posts->id }}</td>
                                <td>{{ $posts->title }}</td>
                ...
                <div class="col-md-12">
                    {{ $draftPosts->links('pagination::bootstrap-5') }}
                </div>
            </div>
        </div>
    </div>
